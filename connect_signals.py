...
def connect_synth_data(self):
    self.track_1_box.currentIndexChanged.connect(lambda: fi.synth_data(self, 1))
    self.track_2_box.currentIndexChanged.connect(lambda: fi.synth_data(self, 2))
    self.track_3_box.currentIndexChanged.connect(lambda: fi.synth_data(self, 3))
...
def connect_play_buttons(self):
    self.play_track_1.clicked.connect(lambda: fi.thread_play_midi(self, 1))
    self.play_track_2.clicked.connect(lambda: fi.thread_play_midi(self, 2))
    self.play_track_3.clicked.connect(lambda: fi.thread_play_midi(self, 3))
